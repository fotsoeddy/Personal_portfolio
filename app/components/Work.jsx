            ...
            <div className='flex justify-center gap-4 mb-10'>
                {categories.map((category) => (
                    <button 
                        ...
                        className={`px-5 py-2 rounded-full border text-sm transition duration-300 ${selectedCategory === category ? 'bg-black text-white' : 'border-gray-400 text-gray-700 hover:bg-gray-200'}`}>
                        {category}
                    </button>
                ))}
            </div>
